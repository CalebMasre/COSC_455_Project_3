...
;; Evaluate one of the following load expressions with the proper buffer name.
;; Then execute the run procedure.
;; NOTE: The buffer with data must be loaded first, and the cursor must be at
;;       the beginning.
;;
;; (load_data "ab.ast")
;; (load_data "euclid.ast")
;; (load_data "euclid2.ast")
;; (load_data "hiding.ast")
;; (load_data "if.ast")
;; (load_data "if2.ast")
;; (load_data "if3.ast")
;; (load_data "if4.ast")
